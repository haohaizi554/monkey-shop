...
class GlobalExceptionHandlerTest {
    ...
    void accessDeniedMapsToForbidden() {
        ...
        assertThat(response.getStatusCode()).isEqualTo(ErrorCode.FORBIDDEN.httpStatus());
        assertThat(response.getBody()).isNotNull();
    ...
    void validationExceptionUsesFirstFieldError() {
        ...
        assertThat(response.getStatusCode()).isEqualTo(ErrorCode.VALIDATION_ERROR.httpStatus());
        assertThat(response.getBody()).isNotNull();
    ...
    void constraintViolationAndBadRequestUseValidationError() {
        ...
        assertThat(constraintResponse.getStatusCode()).isEqualTo(ErrorCode.VALIDATION_ERROR.httpStatus());
        ...
        assertThat(badRequestResponse.getStatusCode()).isEqualTo(ErrorCode.VALIDATION_ERROR.httpStatus());
