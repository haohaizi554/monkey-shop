...
import com.example.monkey.shared.web.GlobalExceptionHandler;
import com.example.monkey.shared.web.TraceIdFilter;
...
class OrderControllerApiContractTest {
    ...
    void versionedOrderReadSupportsPageableEnvelope() throws Exception {
        when(orderService.findAllOrders(any(OrderPageRequest.class)))
