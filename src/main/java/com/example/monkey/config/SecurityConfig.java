...
import com.example.monkey.security.ApiRateLimitFilter;
import com.example.monkey.security.JwtAuthenticationFilter;
import com.example.monkey.security.JwtTokenService;
...
import com.example.monkey.shared.web.UserMdcFilter;
...
public class SecurityConfig {
    ...
    private static void writeProblem(
        ...
        writeJson(response, objectMapper, errorCode.httpStatus().value(), problem, MediaType.APPLICATION_PROBLEM_JSON);
    }
