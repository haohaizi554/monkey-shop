...
public final class CaptchaHttp {
    ...
    public static void write(CaptchaChallenge challenge, HttpServletResponse response) throws IOException {
    ...
    private static void addChallengeCookie(
            HttpServletResponse response, CaptchaChallenge challenge, String challengeId) {
